...
const awsConfig = {
  Auth: {
    identityPoolId: "eu-west-1:ba1bc2ab-23c2-4ae8-808d-74191f708497", // example: 'us-east-2:c85f3c18-05fd-4bb5-8fd1-e77e7627a99e'
    region: "eu-west-1", // example: 'us-east-2'
    userPoolId: "eu-west-1_tJ2jAEn7O", // example: 'us-east-2_teEUQbkUh'
    userPoolWebClientId: "38ajt19nd8hqt681jvducpci2", // example: '3k09ptd8kn8qk2hpk07qopr86'
  },
  API: {
    endpoints: [
      {
